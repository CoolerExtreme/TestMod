...
public class RenderItemRock extends Render
{
    private Item field_94151_a;
    private int field_94150_f;
    private static final String __OBFID = "CL_00001008";

    public RenderItemRock(Item p_i1259_1_, int p_i1259_2_)
    {
        this.field_94151_a = p_i1259_1_;
        this.field_94150_f = p_i1259_2_;
    }

    public RenderItemRock(Item p_i1260_1_)
    {
        this(p_i1260_1_, 0);
    }
    ...
    private void func_77026_a(Tessellator p_77026_1_, IIcon p_77026_2_)
    {
        ...
        p_77026_1_.setNormal(0.0F, 1.0F, 1.0F);
